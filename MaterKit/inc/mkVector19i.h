...
//============================================================================
#ifndef MK_VECTOR19INT_H
#define MK_VECTOR19INT_H

#include "MaterKit.h"
#include "mkGlobalDefs.h"

class mkVector19i   //19Œ¨œÚ¡ø
{
public:
	...
	{ 
		_v[ 0]=0; 
		_v[ 1]=0; _v[ 2]=0; _v[ 3]=0; _v[ 4]=0; _v[ 5]=0; _v[ 6]=0;
		_v[ 7]=0; _v[ 8]=0; _v[ 9]=0; _v[10]=0; _v[11]=0; _v[12]=0;
		_v[13]=0; _v[14]=0; _v[15]=0; _v[16]=0; _v[17]=0; _v[18]=0; 
	}
	mkVector19i(
		mkReal v0,
	...
	inline void set(const mkVector19i& rhs)
	{
		_v[ 0]=rhs._v[ 0]; 
	...
	/* Dot product. */
	inline int operator * (const mkVector19i& rhs) const
	{
	...
	/* Multiply by scalar. */
	inline const mkVector19i operator * (mkReal rhs) const
	{
		return mkVector19i(_v[ 0]*rhs, \
	...
	inline mkVector19i& operator *= (mkReal rhs)
	{
		_v[ 0]*=rhs;
		_v[ 1]*=rhs; _v[ 2]*=rhs; _v[ 3]*=rhs; _v[ 4]*=rhs; _v[ 5]*=rhs; _v[ 6]*=rhs; 
		_v[ 7]*=rhs; _v[ 8]*=rhs; _v[ 9]*=rhs; _v[10]*=rhs; _v[11]*=rhs; _v[12]*=rhs; 
	...
	/** Binary vector add. */
	inline const mkVector19i operator + (const mkVector19i& rhs) const
	{
		return mkVector19i(_v[ 0]+rhs._v[ 0], 
			_v[ 1]+rhs._v[ 1], _v[ 2]+rhs._v[ 2], _v[ 3]+rhs._v[ 3], _v[ 4]+rhs._v[ 4], _v[ 5]+rhs._v[ 5], _v[ 6]+rhs._v[ 6], 
			_v[ 7]+rhs._v[ 7], _v[ 8]+rhs._v[ 8], _v[ 9]+rhs._v[ 9], _v[10]+rhs._v[10], _v[11]+rhs._v[11], _v[12]+rhs._v[12], 
			_v[13]+rhs._v[13], _v[14]+rhs._v[14], _v[15]+rhs._v[15], _v[16]+rhs._v[16], _v[17]+rhs._v[17], _v[18]+rhs._v[18]);
	}
	...
	/* intermediate object.*/
	inline mkVector19i& operator += (const mkVector19i& rhs)
	{
		_v[ 0]+=rhs._v[ 0];
		_v[ 1]+=rhs._v[ 1]; _v[ 2]+=rhs._v[ 2]; _v[ 3]+=rhs._v[ 3]; _v[ 4]+=rhs._v[ 4]; _v[ 5]+=rhs._v[ 5]; _v[ 6]+=rhs._v[ 6]; 
		_v[ 7]+=rhs._v[ 7]; _v[ 8]+=rhs._v[ 8]; _v[ 9]+=rhs._v[ 9]; _v[10]+=rhs._v[10]; _v[11]+=rhs._v[11]; _v[12]+=rhs._v[12]; 
	...
	inline const mkVector19i operator - () const
	{
		return mkVector19i (-_v[0], \
